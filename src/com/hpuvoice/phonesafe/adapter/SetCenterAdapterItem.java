...
public class SetCenterAdapterItem extends BaseAdapter {

	
	private Context context = null;
	private static String[] names = {"联系我们", "关于"};
	private static int[] icons = {R.drawable.item_3,
		R.drawable.item_1};
	public SetCenterAdapterItem(Context context){
